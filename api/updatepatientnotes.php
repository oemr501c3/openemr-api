...
$token = $_POST['token'];
$noteId = add_escape_custom($_POST['noteId']);
...
if ($userId = validateToken($token)) {
    ...
    if ($acl_allow) {
        $strQuery = "UPDATE pnotes SET date = '" . date('Y-m-d H:i:s') . "', body = '" . $notes . "', user = '" . $username . "', title = '" . $title . "', assigned_to = '" . $username . "' WHERE id = ?";

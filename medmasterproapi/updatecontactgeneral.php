...
//$image_title = 'Add Contact Image 1';
...
//            $notes_url = $imageURL . '/openemr/sites/default/documents/userdata/contactimages/' . $image_name;
...
//            echo $strQuery1;exit;
        ...
        if ($result) {
            newEvent($event = 'contact-record-update', $user, $groupname = 'Default', $success = '1', $comments = $strQuery);

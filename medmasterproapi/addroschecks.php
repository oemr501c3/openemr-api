...
//  $pid = 1;
//  $visit_id = 47;
//  $burning_with_urination = 'on';
//  $discharge_from_urethra = 'on';
//  $rashes = 'on';
//  $infections = 'on';
//  $elbow_problems = 'on';
//  $wrist_problems = 'on';
//  $hand_problems = 'on';
//  $hip_problems = 'on';
//$additional_notes = 'These are my new addtional notes';
...
//    echo $strQuery;
    ...
    if ($result) {
        newEvent($event = 'patient-record-insert', $user, $groupname = 'Default', $success = '1', $comments = $strQuery);

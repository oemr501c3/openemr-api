...
//    $strQueryEmail1 = "SELECT * FROM medmasterusers WHERE email LIKE '{$email}'";
//    $resultEmail1 = $db->query($strQueryEmail1);
//
//    $strQueryEmail2 = "SELECT * FROM medmasterusers WHERE email LIKE '{$email}'";
//    $resultEmail2 = $db->query($strQueryEmail2);
//
//    if ($resultEmail1 || $resultEmail2) {
//        $xml_array['status'] = -2;
//        $xml_array['reason'] = 'User for this Email Id already exists';
//    } else {

...
$message_badge = add_escape_custom($_POST['message_badge']);
$appointment_badge = add_escape_custom($_POST['appointment_badge']);
$labreports_badge = add_escape_custom($_POST['labreports_badge']);
$prescription_badge = add_escape_custom($_POST['prescription_badge']);
...
if ($userId = validateToken($token)) {
    ...
    if ($acl_allow) {
        ...
        `labreports_badge`= {$labreports_badge},`prescription_badge`= {$prescription_badge} WHERE token='?'";

...
include_once(dirname(dirname(dirname(__FILE__))) . "/interface/globals.php");
...
$sitesDir = dirname(dirname(dirname(__FILE__))) . "/sites/";
...
$openemrDirName = basename(dirname(dirname(dirname(__FILE__))));

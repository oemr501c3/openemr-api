...
/*	$rosId =28; 
	...
	$heat_or_cold = "New";
	$intolerance = "New";
	$change_in_vision = "New";
	$glaucoma_history = "New";
	$eye_pain = "New";
	$irritation = "New";
	$redness = "New";
	$excessive_tearing = "New";
	$double_vision = "New";
	$blind_spots = "New";
	$photophobia = "New";
	$hearing_loss = "New";
    ...
    $apnea = "New";
    $breast_mass = "New";
	$breast_discharge = "New";
	$biopsy = "New";
	$abnormal_mammogram = "New";
	$cough = "New";
	$sputum = "New";
	...
	$thyroid_problems = "New";
	$diabetes = "New";
	$abnormal_blood = "New";
	$anemia = "New";
	$fh_blood_problems = "New";
	$bleeding_problems = "New";
	$allergies = "New";
	$frequent_illness = "New";
	$hiv = "New";
	$hai_status = "New";

...
//$ss = '123dsad12d';
//$phone_biz = '';
//$phone_home = '012926823';
//$phone_cell = '12321432432';
//$phone_contact = '03339055295';
//$occupation = '';
...
//$race = 'HardlyHuman';
//$ethnicity = '';
//$usertext1 = 'Patient Notes';
//$status = "unmarried";
//$drivers_lincense = "123AE213";
//
//$p_insurance_company = 'Primary Company';
//$p_subscriber_employer_status = 'Employeer';
//$p_group_number = 'Tech Corp';
//$p_plan_name = 'Extreme';
//$p_subscriber_relationship = 'self';
//$p_insurance_id = '';
//
//$s_insurance_company = 'Secondery';
//$s_subscriber_employer_status = 'Employer';
//$s_group_number = 'Tech Corp';
//$s_plan_name = 'test';
//$s_subscriber_relationship = 'Self';
//$s_insurance_id = '';
//
//$o_insurance_company = 'Others';
//$o_subscriber_employer_status = 'Employer';
//$o_group_number = 'testing';
//$o_plan_name = 'other plan';
//$o_subscriber_relationship = 'brother';
//$o_insurance_id = '';


$token = $_POST['token'];
// nickname, suffix,  Emergency Contact Name, Insurance ID Numbe, 
...
$email = $_POST['email']; //d
//$ethnoracial = $_POST['ethnoracial'];
$race = $_POST['race']; //d
$ethnicity = $_POST['ethnicity']; //d
//$interpretter = $_POST['interpretter'];
//$migrantseasonal = $_POST['migrantseasonal'];
...
//                $image_path = $_SERVER['DOCUMENT_ROOT'] . "/openemr/sites/default/documents/{$patient_id}";
            ...
            break;
        case "greenway":
            include 'greenway/PatientDemographicsUpdate.php';
            break;
    }
} else {
    $xml_array['status'] = -2;

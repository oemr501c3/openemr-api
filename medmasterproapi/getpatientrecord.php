...
//        $xml_array['Patient']['notelist'] = $patient_data;
        } else {
...
//                    $v_xml_string .= "<$fieldname>$rowvalue</$fieldname>\n";
...
//        $xml_string .= "</vitalslist>\n";
//            $xml_array['Patient']['vitalslist'] = $v_xml_string;
        } else {
     ...
     break;
        case 'greenway';
            include 'greenway/patientrecordGet.php';
            break;
    }
} else {
    $xml_array['status'] = -2;
